...
from parallel_nets.ResNet_for_cifar10 import *
...
def data_model_load(args, model, kwargs):
    train_dataset = datasets.CIFAR10('D:\data\CIFAR10', True, download=True,
    ...
    test_dataset = datasets.CIFAR10('D:\data/CIFAR10', False, download=True,
                                     transform=transforms.Compose([
                                         transforms.ToTensor(),
                                         transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010))
                                     ]))
