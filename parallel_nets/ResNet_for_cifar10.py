...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block_layers, num_classes=10):
        ...
        self.layer1 = BLock_Layer(block, 64, 64, num_block_layers[0], False)
        self.layer2 = BLock_Layer(block, 64, 128, num_block_layers[1], True)
        self.layer3 = BLock_Layer(block, 128, 256, num_block_layers[2], True)
